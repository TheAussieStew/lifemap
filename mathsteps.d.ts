declare module 'mathsteps' {
    function solveEquation(equation: string): Array<Step>;
    function simplifyExpression(expression: string): Array<Step>;
    function factorPolynomial(polynomial: string): Array<Step>;
    enum ChangeTypes {
